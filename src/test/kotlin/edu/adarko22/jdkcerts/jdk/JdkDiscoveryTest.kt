...
import edu.adarko22.jdkcerts.testutils.createDir
import edu.adarko22.jdkcerts.testutils.createExecutableFile
import edu.adarko22.jdkcerts.testutils.createValidJdk
...
class JdkDiscoveryTest {
    ...
    fun setUp() {
        ...
        jdkDiscovery = JdkDiscovery(systemInfoProvider)
    }
