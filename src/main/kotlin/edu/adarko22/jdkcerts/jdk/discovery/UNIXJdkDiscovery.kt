...
import edu.adarko22.jdkcerts.jdk.JdkCreator
import edu.adarko22.jdkcerts.jdk.impl.JavaInfoResolver
import edu.adarko22.jdkcerts.jdk.impl.keystore.UNIXKeystoreInfoResolver
 ...
 */
class UNIXJdkDiscovery(
    private val systemInfoProvider: SystemInfoProvider = UNIXSystemInfoProvider,
    private val jdkCreator: JdkCreator = JdkCreator(JavaInfoResolver(), UNIXKeystoreInfoResolver),
) : JdkDiscovery {
    ...
    override fun discoverJDKs(customJdkDirs: List<Path>): List<Jdk> {
